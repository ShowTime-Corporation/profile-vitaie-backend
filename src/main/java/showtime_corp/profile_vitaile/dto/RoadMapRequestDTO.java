...
public class RoadMapRequestDTO {
    ...
    @NotBlank(message = "road_analisis can not be empty")
    private String road_analisis;

    @NotBlank(message = "road_proposal can not be empty")
    private String road_proposal;

    @NotBlank(message = "road_ideas can not be empty")
    private String road_ideas;

    @NotBlank(message = "road_keep can not be empty")
