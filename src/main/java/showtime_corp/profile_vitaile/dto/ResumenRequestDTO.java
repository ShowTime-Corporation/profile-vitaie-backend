...
public class ResumenRequestDTO {
    ...
    @NotBlank(message = "resume_info can not be empity")
    private String resume_info;

    @NotBlank(message = "resume_employability can not be empity")
    private String resume_employability;

    @NotBlank(message = "resume_simple can not be empity")
    private String resume_simple;

    @NotBlank(message = "resume_recomendation can not be empity")
